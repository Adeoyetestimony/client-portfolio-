...
(() =>{
    ...
    portfolioItemsContainer.addEventListener("click", (event)=>{
        if(event.target.closest(".portfolio-item-inner")){
            ...
            screeshots = portfolioItems[itemIndex].querySelector(".portfolio-item-img img").getAttribute("data-screenshots");
            // conver screeshots into array
    ...
    function popupSlideshow(){
        ...
        /*activate loader unit the popupImg loaded*/ 
